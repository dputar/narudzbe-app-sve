                    ...
                    if st.button("Izvezi označene u PDF"):
                        ...
                        for idx, row in edited_df.iterrows():
                            if row["Izvezi PDF"]:
                                ...
                                c.drawCentredString(width / 2 - 5*mm, height - 145*mm, broj_dana)  # broj dana centrirano
                                c.drawCentredString(width / 2 - 20*mm, height - 145*mm, datum_od)  # datum od centrirano
