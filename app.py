                    ...
                    if st.button("Izvezi označene u PDF"):
                        ...
                        for idx, row in edited_df.iterrows():
                            if row["Izvezi PDF"]:
                                ...
                                c.drawCentredString(width / 2 - 45*mm, height - 130*mm, ime_prezime)  # ime centrirano
                                c.drawCentredString(width / 2 + 0*mm, height - 150*mm, broj_dana)  # broj dana centrirano
