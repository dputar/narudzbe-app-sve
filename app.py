                    ...
                    if st.button("Izvezi označene u PDF"):
                        ...
                        for idx, row in edited_df.iterrows():
                            if row["Izvezi PDF"]:
                                ...
                                c.drawCentredString(width / 2 - 60*mm, height - 182*mm, datum_do)  # datum do centrirano
                                c.drawCentredString(width / 2 + 42*mm, height - 182*mm, prvi_radni_dan)  # prvi radni dan centrirano
                                c.drawCentredString(width / 2 - 60*mm, height - 210*mm, datum_podnosenja)  # datum podnošenja centrirano
